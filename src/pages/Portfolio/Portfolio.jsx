            ...
            <div className='page-container'>
                <Link to='https://jlvstrasse.github.io/word_play/'>
                    <div className='page-div'>
                        ...
                        <img src={wordPlay} alt="" height="300px" />
                ...
                <Link to='https://minigame-masters.onrender.com/'>
                    <div className='page-div'>
                        <h3 className='page-title'>Minigame Masters</h3>
                        <img src={minigameMasters} alt="" height="300px" />
                ...
                <Link to='https://mikedaleo.github.io/Weather-Dashboard/'>
                    <div className='page-div'>
                        <h3 className='page-title'>Weather Dashboard</h3>
                        <img src={weatherDashboard} alt="" height="300px" />
                ...
                <Link to='https://minigame-masters.onrender.com/'>
                    <div className='page-div'>
                        ...
                        <img src={techBlog} alt="" height="300px" />
