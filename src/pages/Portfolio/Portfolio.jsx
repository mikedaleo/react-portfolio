    ...
    return (
        <>
            ...
            <div className='page-container'>
                <a href='https://jlvstrasse.github.io/word_play/' target="_blank" rel="noopener noreferrer" className='page-link'>
                ...
                <a href='https://minigame-masters.onrender.com/' target="_blank" rel="noopener noreferrer" className='page-link'>
                    <div className='page-div'>
                        <h3 className='page-title'>Minigame Masters</h3>
                        <img src={minigameMasters} alt="Minigame Masters logo, a hooded figure." target="_blank" rel="noopener noreferrer" className='page-img'/>
                ...
                <a href='https://mikedaleo.github.io/Weather-Dashboard/' className='page-link'>
                    <div className='page-div'>
                        <h3 className='page-title'>Weather Dashboard</h3>
                        <img src={weatherDashboard} alt="A screenshot of the Weather Dashboard page." target="_blank" rel="noopener noreferrer" className='page-img'/>
                ...
                <a href='https://tech-blog-h6xe.onrender.com/' target="_blank" rel="noopener noreferrer" className='page-link'>
                    <div className='page-div'>
